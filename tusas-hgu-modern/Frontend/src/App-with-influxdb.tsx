...
function App() {
  ...
  // Use store's currentPage directly - now includes InfluxDB
  ...
  // Keyboard navigation - updated to include InfluxDB
  useEffect(() => {
  ...
  // Navigation functions with data fetching - updated to include InfluxDB
  const navigateToPage = (page: 'main' | 'motors' | 'logs' | 'alarms' | 'stats' | 'influxdb') => {
    ...
    if (['main', 'motors', 'logs', 'alarms', 'stats', 'influxdb'].includes(page)) {
  ...
  // Swipe gesture handling - updated to include InfluxDB
  ...
  // Render page content based on current page - includes InfluxDB Monitor
  ...
  return (
    <div className="modern-dashboard" onTouchStart={handleTouchStart}>
      ...
      <div className="dashboard-header-modern">
        ...
        {/* Page Indicators - includes InfluxDB */}
